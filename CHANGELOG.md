...
Toutes les modifications apportées au projet YCorner sont consignées dans ce fichier, classées par ordre de version.
...
### Sécurité
- Mise en place des premières mesures de sécurité.
